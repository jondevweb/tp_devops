...
<div class="row align-items-center mt-5">
    <div class="col-12 col-lg-3 text-center">
        <img src="../../sources/images/Autres/logoNANA2.jpg" alt="image logo NANA" class="img-fluid">
    </div>
    ...
    <p>C'est l'histoire de 5 nanas, 5 amies unies dans un même combat : <span class="badge badge-warning">Aimer</span>, 
        ...
        <p>
            <a href=""><button type="button" class="btn btn-primary">Rejoignez-nous ! &raquo;</a>Pour suivre nos actions et partager avec nous cette nouvelle aventure!!!!!
        </p>
    </div>
</div>
...
<?= styleTitreNiveau2("L'equipe", COLOR_ASSO) ;   ?>

<div class="row align-items-center">
    <div class="col-12 col-lg-3 text-center">
        <img src="../../sources/images/Animaux/Chats/Odin/Odin.jpg" style="height:250px" alt="image Odin">
    </div>
